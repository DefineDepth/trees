    ...
    <div class="nav-form pointer-events-none js-nav-menu-form">
      <div class="nav-form__content js-form-content">
        ...
        <div class="nav-form__close">
          <button type="button" class="nav-form-close pointer-events-none js-nav-menu-form-close js-nav-menu-form-close-main">
            <i class="icon" data-feather="x"></i>
          </button>
          <button type="button" class="nav-form-close pointer-events-none d-none js-nav-menu-form-close-brand">
            <i class="icon" data-feather="x"></i>
          </button>
        </div>
        ...
        <div class="nav-form__form">
          <div class="-main js-form-form-main">
            @php echo do_shortcode('[ninja_form id=1]'); @endphp
          </div>

          <div class="-brand d-none js-form-form-brand">
